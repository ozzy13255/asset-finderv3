...
3. The existing attribution migration is already applied to the connected Supabase database.
5. Pending approval cards show requested quantities for quantity-based assets.
